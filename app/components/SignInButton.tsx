      ...
      {session ? (
        <Menu as='div' className='relative'>
          <Menu.Button>
            {session?.user?.image ? (
              <>
                <div className='relative flex items-center gap-3 hover:opacity-50'>
                  <Image
          ...
          >
            <Menu.Items className='bg-white dark:text-react absolute left-0 mt-1 flex w-96 origin-top-right flex-col rounded-xl py-6 text-white shadow-lg focus:outline-none dark:bg-white'>
